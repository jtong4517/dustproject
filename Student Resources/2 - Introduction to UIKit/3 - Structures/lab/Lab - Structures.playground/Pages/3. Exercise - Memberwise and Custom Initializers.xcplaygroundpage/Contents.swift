...
print(String(somePlace.latitude) + ", " + String(somePlace.longitude));
/*:
 ...
 */
var myHeight = Height(inches: 63);
print("I am \(myHeight.heightInInches) inches and \(myHeight.heightInCentimeters) centimeters tall.");
